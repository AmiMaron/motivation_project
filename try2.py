...
class AssistantManager:
    ...
    def moderate_message(self, user_input):
        try:
            ...
            return "HARMFUL" in moderation_response.upper()
        
        except Exception as e:
            print(f"Moderation error: {str(e)}")
            return True  # Treat errors as potentially harmful to be safe
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if user_input.lower() == 'exit':
            ...
            break
        if assistant_manager.moderate_message(user_input):
            print("Assistant: I'm sorry, but I can't respond to that kind of language.")
        else:
